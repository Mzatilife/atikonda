                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        ...
                        <p class="small text-muted mb-0"><a href="./blogs.php"><span class="fe fe-book fe-12 text-danger"></span> <span class="text-secondary">view blogs</span></a></p>
                      </div>
              ...
              <div class="col-md-4">
                <div class="card shadow mb-4">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <small class="text-muted mb-1">Gallery Posts</small>
                        <?php
                        $posts = $gallery->countgallery();
                        ?>
                        <h3 class="card-title mb-0">
                          <?php echo $posts ?>
                        </h3>
                        <p class="small text-muted mb-0"><a href="./gallery.php"><span class="fe fe-grid fe-12 text-warning"></span> <span class="text-secondary">view posts</span></a></p>
                      </div>
                      <div class="col-4 text-right">
              ...
              <div class="col-md-4">
                <div class="card shadow mb-4">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <small class="text-muted mb-1">upload blog</small>
                        <h3 class="card-title mb-4"> </h3>
                        <p class="small text-muted mb-0"><a href="./upload_blog.php"><span class="fe fe-upload fe-12 text-success"></span> <span class="text-secondary">upload blog</span></a></p>
                      </div>
                      <div class="col-4 text-right">
                        <span class="fe fe-upload fe-24"></span>
                      </div>
                    </div> <!-- /. row -->
                  </div> <!-- /. card-body -->
                </div> <!-- /. card -->
                      ...
                      <div class="card-body">
                        ...
                        <table class="table datatables" id="dataTable-2">
                          ...
                          <tbody>
                            ...
                            $index = 1;
                            foreach ($row as $rw) {
                              $date = strtotime($rw['upload_date']);
                              // $comments = $gallery->countComments($rw['gallery_id']);
                            ?>
                              <tr>
                                <td><?php echo $index; ?></td>
                                <td scope="col" style="text-transform:capitalize;"><?php echo $rw['event']; ?></td>
                                <td> <img src="../img/gallery/<?php echo $rw['image']; ?>" style="width: 75px; border-radius:5%;" alt="" srcset=""></td>
                                ...
                                <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="gallery.php?view_id=<?php echo $rw['gallery_id'] ?>">View</a>
                                    <a class="dropdown-item" href="gallery.php?edit_id=<?php echo $rw['gallery_id'] ?>">Edit</a>
                                    <a class="dropdown-item text-danger" href="gallery.php?gdel_id=<?php echo $rw['gallery_id'] ?>">Remove</a>
                                  </div>
                                </td>
                              </tr>
                            <?php
