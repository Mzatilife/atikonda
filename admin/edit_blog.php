                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 form-group mb-3">
                                            ...
                                            <div class="row">
                                                <img src="../img/blog/<?php echo $row['image'] ?>" class="col-4" width="100%" height="50px" alt="">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control required" name="content" id="edit" required="" rows="6"><?php echo $row['content'] ?></textarea>
                                            <div class="valid-feedback"> Looks good! </div>
