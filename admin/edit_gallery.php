...
$row = $gallery->viewgalleryById($edit);
...
if (isset($_POST['submit'])) {
    ...
    $gallery_id = TestInput($_POST['gallery_id']);
    ...
    if (in_array($file_extension, $valid_ext)) {
        ...
        $result = $gallery->editgallery($cat, $title, $new_name, $content, $gallery_id);
        if ($result) {
            $msg = "Post edited";
            header('refresh:2, url=edit_gallery.php');
        } else {
            $msg2 = "Error, couldn't edit the post";
        }
    } else {
                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom3">Post Title *</label>
                                            <input type="text" name="title" class="form-control required" id="validationCustom3" value="<?php echo $row['event'] ?>" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                            <div class="invalid-feedback"> gallery title required </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <div class="row">
                                                <img src="../img/gallery/<?php echo $row['image'] ?>" class="col-2" width="100%" height="50px" alt="">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="validationTextarea1">Caption *</label>
                                            <textarea class="form-control required" name="content" id="edit" required="" rows="6"><?php echo $row['caption'] ?></textarea>
                                            <div class="valid-feedback"> Looks good! </div>
                                            <div class="invalid-feedback"> Caption required. </div>
                                        </div>
                                    </div>
                                    <input type="number" value="<?php echo $row['gallery_id'] ?>" name="gallery_id" hidden>
