...
$row = $planters->viewPlantsById($edit);

if (isset($_POST['submit'])) {

    unlink("../img/plants/" . $row['image']);
    ...
    $plant_id = TestInput($_POST['plant_id']);
    ...
    if (in_array($file_extension, $valid_ext)) {
        ...
        $result = $planters->editPlants($cat, $new_name, $name, $description, $plant_id);
        if ($result) {
            $msg = "Plant edited";
            header('refresh:2, url=edit_plant.php');
        } else {
            $msg2 = "Error, couldn't edit the plant";
        }
    } else {
                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Edit Plant</strong>
                            </div>
                            <div class="card-body">
                                <?php
                                if (isset($msg)) { ?>
                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom3">Plant Name *</label>
                                            <input type="text" name="name" class="form-control required" id="validationCustom3" value="<?php echo $row['plant_name'] ?>" required>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="customFile">Plant Image *</label>
                                            <div class="row">
                                                <img src="../img/plants/<?php echo $row['image'] ?>" class="col-4" width="100%" height="50px" alt="">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="validationTextarea1">Plant Description *</label>
                                            <textarea class="form-control required" name="content" id="edit" required="" rows="6"><?php echo $row['plant_description'] ?></textarea>
                                            <div class="valid-feedback"> Looks good! </div>
                                            <div class="invalid-feedback"> Required. </div>
                                        </div>
                                    </div>
                                    <input type="number" value="<?php echo $row['plant_id'] ?>" name="plant_id" hidden>
