...
if (isset($_POST['add'])) {
    ...
    $result = $gallery->addCategory($category);
...
if (isset($_POST['edit'])) {
    ...
    // passing login information
    $result = $gallery->editCategory($id, $category);
...
if (isset($_GET['del_id'])) {
    ...
    $result = $gallery->deleteCategory($id);
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <strong class="mb-1">Gallery Categories</strong><span class="dot dot-lg bg-success ml-1"></span>
                                        <p class="small text-muted mb-1">This shows all gallery categories. For new category hit the new category button.</p>
                                    </div>
                                        ...
                                        <table class="table datatables" id="dataTable-1">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($row as $rw) {
                                                    ...
                                                    $gallerys = $gallery->countgalleryAndCategory($cat_id);
                                                ?>
                                                    <tr>
                                                        <td><?php echo $index; ?></td>
                                                        <td id="cat_name<?php echo $rw['category_id'] ?>" style="text-transform:capitalize;"><?php echo $rw['category_name']; ?></td>
                                                        <td>
                                                            <span class="badge badge-pill badge-info"><?php echo $gallerys ?></span>
                                                        </td>
                                                        <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item text-danger" href="gallery-categories.php?del_id=<?php echo $rw['category_id'] ?>">Remove</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
