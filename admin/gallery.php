                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <strong class="mb-1">Upload Posts</strong><span class="dot dot-lg bg-success ml-1"></span>
                                        <p class="small text-muted mb-1">This shows all posts that have been uploaded. For new gallery click the upload new button.</p>
                                    </div>
                                    <div class="col-4 col-md-auto offset-4 offset-md-0 my-2">
                                        <a href="upload_gallery.php" class="btn btn-sm btn-info">upload new</a>
                                    </div>
                                </div>
                            </div> <!-- / .card-body -->
                        </div> <!-- / .card -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item text-danger" href="gallery.php?del_id=<?php echo $rw['gallery_id'] ?>">Remove</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
