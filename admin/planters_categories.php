...
if (isset($_POST['add'])) {
    ...
    $result = $planters->addCategory($category);
...
if (isset($_POST['edit'])) {
    ...
    // passing login information
    $result = $planters->editCategory($id, $category);
...
if (isset($_GET['del_id'])) {
    ...
    $result = $planters->deleteCategory($id);
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <strong class="mb-1">Plants Categories</strong><span class="dot dot-lg bg-success ml-1"></span>
                                        <p class="small text-muted mb-1">This shows all plant categories. For new category click the new category button.</p>
                                    </div>
                                        ...
                                        <table class="table datatables" id="dataTable-1">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($row as $rw) {
                                                    ...
                                                    $plants = $planters->countPlantsAndCategory($cat_id);
                                                ?>
                                                    <tr>
                                                        <td><?php echo $index; ?></td>
                                                        <td id="cat_name<?php echo $rw['category_id'] ?>" style="text-transform:capitalize;"><?php echo $rw['category_name']; ?></td>
                                                        <td>
                                                            <span class="badge badge-pill badge-info"><?php echo $plants ?></span>
                                                        </td>
                                                        <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item text-danger" href="planters_categories.php?del_id=<?php echo $rw['category_id'] ?>">Remove</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
