...
if (isset($_POST['submit'])) {
    ...
    if (in_array($file_extension, $valid_ext)) {
        ...
        $result = $gallery->addgallery($cat, $title, $new_name, $content);
        if ($result) {
            $msg = "Post Uploaded";
        } else {
            $msg2 = "Error, couldn't upload the post";
        }
    } else {
                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Upload Post</strong>
                            </div>
                            <div class="card-body">
                                <?php
                                if (isset($msg)) { ?>
                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom3">Posts Event *</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="validationTextarea1">Post Caption *</label>
