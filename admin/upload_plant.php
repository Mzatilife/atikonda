...
if (isset($_POST['submit'])) {
    ...
    if (in_array($file_extension, $valid_ext)) {
        ...
        $result = $planters->addPlants($cat, $new_name, $name, $content);
        if ($result) {
            $msg = "Plant Uploaded";
        } else {
                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Upload Plant</strong>
                            </div>
                            <div class="card-body">
                                <?php
                                if (isset($msg)) { ?>
                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control required" id="validationCustom3" placeholder="enter title" required>
