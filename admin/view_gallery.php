...
$row = $gallery->viewgalleryById($view);
                        ...
                        <div class="col-lg-12">
                            <div class="single-post">
                                <div class="gallery_details">
                                    <img class="float-left mr-3 img-thumbnail img-responsive" style="max-height: 200px;" src="../img/gallery/<?php echo $row['image']; ?>" alt="image">
                                    <h3>
                                        <?php echo $row['event']; ?>
                                    </h3>
